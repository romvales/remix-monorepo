            ...
            <section 
              ...
              <div
                ...
                <div className='py-[2rem] px-[1rem] lg:px-[4rem] space-y-2'>
                  ...
                  <div>
                    <h3 className='romvales-h2'>{copywriting.title}</h3>
            ...
            <section 
              ...
              <div
                ...
                <div className='py-[2rem] px-[1rem] lg:px-[4rem]'>
                  ...
                  <h3 className='romvales-h2'>{design.title}</h3>
        ...
        <section id='faqs'>
          <div className='romvales-container '>
            <div className={
              ...
              <h2 className='romvales-h1'>Got any questions? I'm here to answer and help.</h2>
            </div>
