...
const MetatagsSchema = z.object({
  ...
  ['/jobs']: z.custom<ReturnType<MetaFunction>>(),
  ['/jobs/applications']: z.custom<ReturnType<MetaFunction>>(),
  ['/jobs/for-employers']: z.custom<ReturnType<MetaFunction>>(),
  ['/jobs/about']: z.custom<ReturnType<MetaFunction>>(),
})
